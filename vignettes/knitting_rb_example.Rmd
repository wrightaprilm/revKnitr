...
```{rb, knitr::knit_engines$set(rb = RevGadgets::eng_rb)}
example <- 1.0 
example
```
...
Oh No! We have made a typo in an RB chunk! How can we fix our error? Erase the above block. Use the below code, and choose the downward-facing grey arrow to run it.
